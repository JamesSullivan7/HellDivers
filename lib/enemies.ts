...
export const ENEMY_TEMPLATES: Record<string, EnemyTemplate> = {
  ...
  raider: {
    ...
    faction: "automaton",
    intentPattern: [
      { kind: "attack", damage: 5, text: "Volley 5" },
      { kind: "attack_all", damage: 2, text: "Suppress All 2" },
    ],
  },
  devastator: {
  ...
  elevated_overseer: {
    id: "elevated_overseer",
    name: "Elevated Overseer",
    hp: 28,
    armor: 1,
    shield: 10,
    faction: "illuminate",
  ...
  monolith: {
    ...
    isBoss: true,
    intentPattern: [
      { kind: "attack", damage: 14, text: "Annihilate 14" },
      { kind: "attack_all", damage: 7, text: "Reality Tear — All 7" },
      { kind: "buff", text: "Phase Shield (+8)" },
      { kind: "attack", damage: 10, text: "Lance 10" },
    ],
    enragedMessage: "MONOLITH PHASE-SHIFT. REALITY DESTABILIZING.",
    enragedPattern: [
      { kind: "attack", damage: 18, text: "Reality Lance 18" },
      { kind: "attack_all", damage: 12, text: "Phase Wave — All 12" },
      { kind: "buff", text: "Phase Shield (+12)" },
    ],
  },
};
